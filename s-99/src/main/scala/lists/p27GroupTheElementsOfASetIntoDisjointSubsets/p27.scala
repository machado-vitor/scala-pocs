package lists.p27GroupTheElementsOfASetIntoDisjointSubsets

import lists.p26GenerateTheCombinationOfKDistinctObjectsChosenFromTheNElementsOfAList.combinations
